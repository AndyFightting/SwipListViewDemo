...
import com.suguiming.swiplistview.adapter.PackageAdapter;
import com.suguiming.swiplistview.adapter.PackageItem;
import com.suguiming.swiplistview.dialog.AboutDialog;
import com.suguiming.swiplistview.library.BaseSwipeListViewListener;
import com.suguiming.swiplistview.library.SwipeListView;
import com.suguiming.swiplistview.utils.PreferencesManager;
...
public class SwipeListViewExampleActivity extends FragmentActivity {
    ...
    public void settingTap(View view){
        Intent intent = new Intent(this, SettingsActivity.class);
        startActivityForResult(intent, REQUEST_CODE_SETTINGS);
